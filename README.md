...
11. Create Fare for the Flight
12. Create BaggagePolicy for the Flight
13. Create FareRule for the Flight
14. Create FlightMeal for the Flight
15. Create FlightCabinAncillary for the Flight and Cabin Class 
16. Create Flight Schedule for the Flight (Will create Flight Instances for the Flight Schedule, 
send "flight_instance_created" and creates Flight Instance Cabin and Seat Instance for the Flight Instance Cabin)
17. Search for Flights based on origin, destination and date 
18. Book a Flight Instance for a Passenger (Will create Booking and Booking Instance for the Flight Instance, send "booking_created" and creates Booking Instance Cabin and Seat for the Booking Instance Cabin)
19. Complete the payment using provider generated payment link
20. Verify the payment using provider payment id